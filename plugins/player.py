...
async def not_chat(_, m: Message):
    ...
    k=await m.reply("<b>No puedes usar este bot en este grupo, para eso tienes que hacer tu propio bot desde el [Soure Code 👈](https://github.com/LushaiMusic/VCMusicPlayer) below.</b>", disable_web_page_preview=True, reply_markup=InlineKeyboardMarkup(buttons))
    await mp.delete(m)
